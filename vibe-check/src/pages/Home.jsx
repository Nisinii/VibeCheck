...
const Home = () => {
  ...
  const { places, isLoading, error: fetchError, fetchPlaces } = usePlacesFetcher(apiReady, activeMood, searchQuery);
  ...
  }, [apiReady, activeMood, searchQuery, fetchPlaces]);
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-indigo-100">
      ...
      {/* Main Content Area */}
      <main className="relative z-10 px-4 md:px-12 2xl:px-24 w-full mx-auto pb-20 md:pb-32 min-h-[400px]">
        {isLoading ? (
