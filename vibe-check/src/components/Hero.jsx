...
import { Search, Zap, Map, Navigation } from 'lucide-react';
import { MOODS } from '../utils/constants';

const Hero = ({ searchQuery, setSearchQuery, activeMood, setActiveMood, radius, setRadius }) => (
          ...
          <div className="space-y-6 xl:space-y-8">
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input 
                  type="text" 
                  placeholder="Keyword filter (e.g. 'Coffee', 'Sushi')..."
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center px-1">
                <label className="text-[10px] uppercase font-bold tracking-widest text-slate-400">Detection Radius</label>
